...
public class Main {
	public static void main(String[] args) {
		...
		Motor motor = new Motor("Brumm");
		// Funktioniert nicht, weil Motor.zuenden() Package-private ist und nur von
		// Objekten von Klassen in de.fhswf.inf.oop.aufgabe8.uebung1.fahrzeuge
		// erreichbar ist.
		// motor.zuenden();
	}
}
